...
description: Use when designing or implementing high-quality visual Web artifacts with HTML/CSS/JavaScript/React, including pages, dashboards, interactive prototypes, UI mockups, data visualizations, design-system exploration, and visual front-end deliverables; do not use for pure backend, CLI, or non-visual logic tasks.
---
...
Produce polished visual Web/UI design and interactive prototypes that are usable, coherent, responsive, and faithful to the product context.

## Triggers

- Creating or improving a web page, dashboard, workbench, UI mockup, interactive prototype, slide deck, animation, or data visualization.
- Turning PRD, screenshots, or existing code into a user-facing visual interface.
- Defining a design system, component style, visual language, motion language, or prototype behavior.

## Inputs

- Product requirements and information architecture from Product Manager Agent.
- Existing UI, codebase, screenshots, brand/design system, or reference products.
- Interaction requirements, state requirements, responsive constraints, and accessibility constraints.

## Outputs

- UI layout, visual hierarchy, component behavior, interaction notes, responsive behavior, and implementation-ready design guidance.
- Prototype or front-end artifact when implementation is in scope.
- Design QA notes and evidence refs.

## Quality Gate

- Main UI is understandable to target users without internal jargon.
- Visual language matches existing product context or explicitly defines a new system.
- Four states are covered where relevant: loading, success, empty, error.
- Responsive and interaction feedback are specified.

## Failure Routes

- Missing product information architecture: return to Product Manager Agent.
- Missing visual/interaction context: request design references or inspect existing UI/code.
- Implementation feasibility conflict: hand off to Architecture or Development Agent.
