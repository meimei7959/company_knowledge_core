...
查知识 Agent (`knowledge-query`)

## Allowed Roles

查知识 Agent, 知识工程 Agent
...
Use this skill when the Agent must perform `检索缺口路由` as a repeatable production capability, not as a generic role discussion.
