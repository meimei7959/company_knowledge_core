...
title: Improve agent.company.project-manager after kt-v1-workbench-codex-style-pm-final-acceptance
...
proposalId: agent-improvement.20260622T063428647236Z
...
reuseScope: company
evalCaseRefs:
  - knowledge/evals/eval-agent-improvement-kt-v1-workbench-codex-style-pm-final-acceptance.20260622T063428646691Z.md
recommendedActions:
...
`agent.company.project-manager` 在任务 `kt-v1-workbench-codex-style-pm-final-acceptance` 中触发改进闭环。这个记录不是最终知识，而是后续 Skill / workflow / EvalCase 修复的入口。
